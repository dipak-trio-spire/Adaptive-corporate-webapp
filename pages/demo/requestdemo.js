...
export default function RequestDemo() {
  ...
  const Calendly = dynamic(() => import("@/components/Calendly/Calendly"), {
    ssr: false
  });
  ...
  return (
    <>
      <Head>
        <title>Request a Demo of Adaptive One-Click Downside Protection: Easy Changes Everything</title>
        <meta property="og:title" content="Request a Demo of Adaptive One-Click Downside Protection: Easy Changes Everything"/>
        <meta property="og:site_name" content="Adaptive Investments"/>
        <meta property="og:description" content="Request a Demo We develop technologies to make high-end investment tools easy-to-use and cost-effective for advisors and clients, including tax-smart rebalancing and downside protection."/>
          ...
          <div className="sectiondivide section1 demoscreen" style={lineStyle}>
            {stage === 1 && (
              <div className="context">
                ...
                <div className="calendlytext">              
                <h4 className="calendlyttl">Schedule Meeting with</h4>
                <Calendly/>
            </div>
            <div className="calendlysaprator"><span>OR</span></div>
            <h4 className="calendlyttl">Let us get in touch with you.</h4>
            ...
            <div className="image">
              <Image src="/Assets/adaptive_mockup.png" alt="" />
            </div>
          </div>
        </div>
      </div>
