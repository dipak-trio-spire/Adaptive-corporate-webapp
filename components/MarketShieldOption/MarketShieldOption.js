...
export default function MarketShieldOption(props) {
  ...
  const fetchInteractiveMarketShield = (e) => {
    e.preventDefault();
    ...
    if (validFlag) {
      if (pli.length > 0) {
        ...
        setApiRequest(raw);
        setBdOpen(true);
        FetchInteractiveMarketShield(raw).then((market_data) => {
          ...
          if (market_data !== false && market_data !== 0 && market_data !== undefined) {
            ...
            TagManager.dataLayer({
              dataLayer: {
                ...
                apiName: 'Market Shield Option Contracts'
              },
            });
          }
  ...
  return (
    <>
      ...
      <div className='apidata'>
        ...
        <a className='ai-btn primary solid' onClick={fetchInteractiveMarketShield}>Post result</a>
      </div>
