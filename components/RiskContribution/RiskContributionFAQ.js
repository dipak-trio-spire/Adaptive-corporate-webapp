...
function RiskContributionFAQ({ hostname }) {
            ...
            <div className="sectiondivide sectioncol ptsec">
                ...
                <div className="faqcon">
                    ...
                    <div className="faq" id="faq3">
                        <h4 onClick={() => setShow3(!show3)}>3. What is downside protection? {show3 && <span className="minus">-</span>} {!show3 && <span>+</span>}</h4>
                    ...
                    <div className="faq" id="faq4">
                        <h4 onClick={() => setShow4(!show4)}>4. How do I request an Adaptive pilot account to manage investment risks? {show4 && <span className="minus">-</span>} {!show4 && <span>+</span>}</h4>
                        {show4 && <div className="content">
                            <p>Adaptive seeks to smooth out the ride—and level the playing field—so investors can stay invested for long-term growth with tools which are otherwise the province of the ultra high-net-worth. <a href="https://adaptive-investments.com/requestdemo" target="_blank" className="ai-link">Request an Adaptive demo or pilot account to test drive our breakthrough fintech technology</a>. Pilot users can securely link brokerage accounts for automated risk analysis and downside protection pricing. </p>
                        </div>}
                    </div>
                </div>
            </div>
...
export default RiskContributionFAQ;