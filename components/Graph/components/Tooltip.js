...
const Tooltip = ({
  ...
  const onChangePosition = React.useCallback((d, i, isVisible) => {
    d3.selectAll(".performanceItemValue")
      ...
      .text(isVisible ? Number((d.label).toFixed(2)).toLocaleString('en-US') : "");
  ...
  return (
    <g ref={ref} opacity={1} {...props}>
      ...
      <g className="tooltipContent">
        <rect className="contentBackground" rx={4} ry={4} fill = "#e6e6fa" opacity={0.8} />
...
Tooltip.propTypes = {
  ...
  anchorEl: typeof Element !== 'undefined' ? PropTypes.instanceOf(Element) : PropTypes.any
};
