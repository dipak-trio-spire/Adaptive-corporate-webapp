...
const VIXMultilineChart = ({ data = [], margin = {} }) => {
  ...
  const { yTickFormat, xTickFormat, xScale, yScale, yScaleForAxis, xNewTickFormat } =
    controller;
...
VIXMultilineChart.defaultProps = {
  data: [],
  margin: {
    top: 30,
    right: 30,
...
export default VIXMultilineChart;
